...
//it is used in the Dashboard.jsx file to filter the transactions based on the selected time frame
//it is uthaya hua function it means i dont write it at all