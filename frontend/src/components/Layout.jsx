...
const API_BASE = "https://myrevenue-backend.onrender.com/api";
...
const Layout = ({ onLogout, user, token }) => {
  ...
  // to get the top 5 categories with the highest expenses in the last 30 days
            ...
            <div className={styles.cards.base}>
              <div className={styles.cards.header}>
                <h3 className={styles.cards.title}>
                  <TrendingUp size={20} className="w-6 h-6 text-teal-500" />
                  Financial Overview
            ...
            <div className={styles.cards.base}>
              <div className={styles.transactions.cardHeader}>
                <h3 className={styles.transactions.cardTitle}>
                  <Clock size={20} className="w-6 h-6 text-purple-500" />
                  Recent Transactions
                </h3>
                <button
