...
export const profileStyles = {
  ...
  mainContainer:
    "bg-white -mx-7 rounded-3xl shadow-md overflow-hidden border border-teal-100",

  header:
    "bg-gradient-to-br from-teal-500 via-cyan-500 to-emerald-500 p-8 text-center",

  avatar:
    "w-24 h-24 mx-auto rounded-3xl bg-white/20 flex items-center justify-center mb-4 border border-white/30 shadow-lg",

  userName: "text-2xl font-bold text-white",

  userEmail: "text-teal-50 mt-2",
  ...
  card:
    "bg-gradient-to-br from-teal-50/70 to-cyan-50/70 rounded-2xl p-6 border border-teal-100 shadow-sm",

  cardTitle:
    "text-xl font-semibold pb-3 text-gray-800 flex items-center",
  ...
  input:
    "w-full px-4 py-2 bg-white border border-teal-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-400",

  inputWithError:
    "w-full px-4 py-2 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-200 focus:border-teal-400",

  buttonPrimary:
    "flex-1 bg-gradient-to-r from-teal-500 to-cyan-500 text-white py-2.5 rounded-xl font-medium shadow-md hover:shadow-lg hover:from-teal-600 hover:to-cyan-600 transition-all",

  buttonSecondary:
    "flex-1 py-2.5 border border-teal-200 text-teal-700 rounded-xl font-medium hover:bg-teal-50 transition-all",

  editButton:
    "text-teal-600 hover:text-teal-700 font-medium text-sm transition-colors",

  changeButton:
    "text-teal-600 hover:text-teal-700 font-medium lg:text-sm transition-colors",

  securityItem:
    "flex items-center justify-between p-4 bg-white rounded-xl border border-teal-100 shadow-sm",

  securityText: "font-medium lg:text-sm text-gray-500",

  modalContent:
    "bg-white rounded-3xl p-6 lg:px-28 w-full max-w-md shadow-xl border border-teal-100",
  ...
  passwordToggle:
    "absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-teal-600",
...
export const loginStyles = {
  pageContainer:
    "min-h-screen flex items-center justify-center p-4 bg-teal-50",

  cardContainer:
    "w-full max-w-md bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-200",

  header:
    "bg-teal-500 p-7 text-center",

  // Circular logo
  avatar:
    "w-20 h-20 mx-auto rounded-full bg-white/20 flex items-center justify-center mb-4 border border-white/30",

  headerTitle: "text-3xl font-bold text-white",

  headerSubtitle: "text-teal-100 mt-2 text-sm",

  formContainer: "p-8",

  errorContainer:
    "mb-5 p-3 bg-red-50 border border-red-200 text-red-700 rounded-xl flex items-center text-sm",
  ...
  // Black icons
  inputIcon:
    "absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-black",

  // Grey border
  input:
    "w-full pl-11 pr-4 py-3 bg-teal-50 border border-gray-300 rounded-2xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all",

  passwordInput:
    "w-full pl-11 pr-11 py-3 bg-teal-50 border border-gray-300 rounded-2xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all",

  passwordToggle:
    "absolute inset-y-0 right-0 pr-4 flex items-center text-black hover:text-teal-500 transition-colors",

  checkboxContainer: "mb-6 flex items-center",

  checkbox:
    "w-4 h-4 text-teal-500 border-gray-300 rounded focus:ring-teal-400",

  checkboxLabel: "ml-2 block text-sm text-gray-600",

  button:
    "w-full bg-teal-500 text-white py-3 rounded-2xl font-semibold hover:bg-teal-600 transition-all flex items-center justify-center",
  ...
  signUpLink:
    "font-semibold text-teal-500 hover:text-teal-600 hover:underline",
...
export const signupStyles = {
  ...
  header:
    "bg-teal-500 p-7 text-center relative",
  ...
  apiError:
    "mb-5 p-3 bg-red-50 border border-red-200 text-red-700 rounded-xl text-sm text-center",
